...
--  This file implements test cases for the Process_Var_Assign subprogram
--  defined in MI.Utils.
...
procedure Process_Var_Assign_Test is
   ...
   begin
      Process_Var_Assign (Error, Var_Obj);
   ...
   procedure Var_Assign_Record is
      Rec      : MI_Record_Access :=
                   MI_Get_First_Record ("tests/utils/var-assign-test-1.mi");
      Var_Obj  : Var_Obj_Type;

   begin
      begin
         Process_Var_Assign (Result_Record (Rec.all), Var_Obj);
         Clear_MI_Record (Rec);
         Free_MI_Record (Rec);
